...
public interface TransactionRepository extends JpaRepository<Transaction, Long>
{
    ...
    @Query(value = "SELECT \n"
            + "    t.*,\n"
            + "    ba_source.account_number AS source_account_number,\n"
            + "    ba_dest.account_number AS destination_account_number,\n"
            + "    u.name AS user_name\n"
            + "FROM \n"
            + "    transactions t\n"
            + "INNER JOIN \n"
            ...
            + "INNER JOIN \n"
            + "    users u ON (ba_source.fk_users = u.pk_users OR ba_dest.fk_users = u.pk_users)\n"
            + "WHERE \n"
