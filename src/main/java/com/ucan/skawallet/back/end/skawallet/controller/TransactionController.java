...
public class TransactionController
{
    ...
    public ResponseEntity<List<TransactionDetailsDTO>> getTransactionDetails(@PathVariable Long userId)
    {
        List<TransactionDetailsDTO> transactions = transactionService.getTransactionHistoryByUser(userId);
